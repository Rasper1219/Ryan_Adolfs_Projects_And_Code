...
private: 
    ...
    {   
        ...
        if (nInsidePointCount == 0) { //all points outside of plane, clip whole triangle
            return 0;
        }
        if (nInsidePointCount == 3) {//all points lie on the inside of plane, do nothing
            out_tri1 = in_tri;
            return 1;
        }
...
public:
    ...
    bool OnUserUpdate(float fElapsedTime) override
    {
        ...
        mat4x4 matWorld;
        matWorld = Matrix_MakeIdentity();	// Create World Matrix
        ...
        {   
            ...
            if (Vector_DotProduct(normal,vCameraRay) < 0.0f) {
                ...
                for (int n = 0; n < nClippedTriangles; n++)
                {
                    ...
                    //project triangles from 3d into 2d screen
