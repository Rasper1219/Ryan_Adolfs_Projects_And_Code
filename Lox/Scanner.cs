...
namespace CraftingInterpreters.Lox
{
    ...
    {   
        ...
        private void Number()
        {
            ...
            if (double.TryParse(numberText, out double numericValue))
            {
                AddToken(TokenType.NUMBER, numericValue);
            }
            else
            {
                Lox.Error(line, "Invalid numeric format.");
            }
        }
        ...
        private char Peek() // kind of like a lookahead, takin a little peek 
        {
            if (IsAtEnd()) return '\0';
